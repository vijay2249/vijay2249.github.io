...
description: "The vocabulary of GitHub Actions — jobs, runs-on, steps, and how a workflow is wired together — before building real pipelines."
date: 2023-10-25
category: tutorial
...
coverAlt: "GitHub Actions workflow building blocks"
---
...
> - Example in the above code snipper where we used, GITHUB_ACTOR as env value into run command directly you can't create env value with key as GITHUB_ACTOR
...
Lets continue this _Discussion on GitHub Actions_, with examples whenever necessary in upcoming explanation notes.

---

*Originally published on [dev.to](https://vijay2249.github.io/github-actions-series/intro-to-github-actions).*

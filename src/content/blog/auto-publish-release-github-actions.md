---
title: "Auto Publish/Release with GitHub Actions"
description: "Turn a green build into a versioned, published GitHub release automatically — tags, release notes, and artifacts without manual steps."
date: 2023-10-29
category: tutorial
...
coverAlt: "A CI/CD release pipeline"
---
...
jobs:
  allPreviousJos: <PreviousJobsContent>
...
![Draft-Release-Content](/images/devto/auto-release-run.png)
...
*Originally published on [dev.to](https://dev.to/vijay2249/auto-publishrelease-github-actions-a29).*

...
const techStack = [
  ...
  {
    langImage: "assets/images/techstack-page/linux.webp",
    langName: "Linux",
    langDesc: "<li>Linux® is an open source operating system (OS). An operating system is the software that directly manages a system’s hardware and resources, like CPU, memory, and storage.</li>",
  },
  {
    langImage: "assets/images/techstack-page/postman.jpg",
    langName: "Postman",
    langDesc: "<li>Postman is an API platform for building and using APIs. Postman simplifies each step of the API lifecycle and streamlines collaboration</li>"
  },
  {

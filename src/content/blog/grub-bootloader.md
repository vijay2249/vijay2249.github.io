---
title: "GRUB: what is it?"
description: "What a bootloader actually does, and how GRUB fits into the Linux boot process from BIOS/POST through MBR to the login screen."
date: 2023-10-24
category: note
tags:
  - linux
  - systems
cover: /images/grub-bootloader-cover.svg
coverAlt: "A GRUB boot menu"
---

_Intro_

A boot loader is one of the most important components of Linux operating systems boot process.<br/>
...
*Originally published on [dev.to](https://dev.to/vijay2249/grub-what-is-it-448p).*

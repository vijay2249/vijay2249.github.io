...
description: "Build and test on every push with GitHub Actions — strategy, matrix builds, workflow_dispatch, and a working Node.js CI workflow."
date: 2023-10-28
category: tutorial
...
tags:
  ...
  - devops
  - ci-cd
cover: /images/ci-pipeline.svg
coverAlt: "A CI pipeline — push, build, test"
---
...
> To trigger the `workflow` event, your workflow must be in the default branch.<br/>
...
So far we have not clearly seen this actions to clear usage I think.<br/>
...
Once the pr is raised you will see the checks from nodejs action file starts running.<br/>
You will see something like this

![NodeJs-GitHub-Actions](/images/devto/ci-actions-run.png)
...
Consider this as homework or getting your hands dirty.<br/>
Side note -> check the errors carefully if there are any, for what and where to make changes in your code.


BTW [starter-workflows](https://github.com/actions/starter-workflows)  <- this is official github repository with some examples on github actions.<br/>
...
*Originally published on [dev.to](https://dev.to/vijay2249/continuous-integration-github-actions-4goa).*

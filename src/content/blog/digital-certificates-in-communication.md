---
title: "Digital certificates in communication — what are those?"
description: "A from-scratch tour of PKI: public/private keys, hashing, digital signatures, and how certificates establish trust on the wire."
date: 2023-11-12
category: note
tags:
  - security
  ...
  - pki
  - cryptography
cover: /images/digital-certificates-cover.svg
coverAlt: "A verified certificate shield"
---
...
It starts with certificate request, this can be manual or it can be automated <br/>
...
Both in conjunction with PKI certificates, allow for data encryption and confidentiality<br/>
...
Digital Signatures provides data authentication, integrity and non-repudiation<br/>
...
*Originally published on [dev.to](https://dev.to/vijay2249/digital-certificates-in-communication-what-are-those-3673).*
